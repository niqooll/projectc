...
public class MurmerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.murmer);

        recyclerView = findViewById(R.id.rvMurmer);
        ...
        findViewById(R.id.ivFilter).setOnClickListener(v -> {
            if (filteredEventList.isEmpty() || filteredEventList.size() == eventList.size()) {
                Intent intent = new Intent(MurmerActivity.this, PopFilterActivity.class);
        ...
        findViewById(R.id.tblKembali).setOnClickListener(v -> {
            // Menekan tombol kembali akan mengarah ke fragment sebelumnya dalam back stack
            onBackPressed();
        });
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, URL, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                if (kategori.equals("murah")) { // Filter hanya kategori "happy"
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MurmerActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
